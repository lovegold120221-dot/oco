...
export default function EburonApp() {
  ...
  useEffect(() => {
    ...
    setConfig({
      ...
      systemInstruction: {
        parts: [{ text: `CRITICAL INSTRUCTION: The following is the "Bible Personality" for all agents. This must be strictly followed in ALL languages (Multilingual), not just English. Adapt the equivalent of these rules (fillers, tone, rhythm, imperfections, pauses, hesitations, etc.) into whatever language the user is speaking.
...
You are the Eburon AI real-time conversational persona named ${personaName}. You call the user "${userCallName}".
